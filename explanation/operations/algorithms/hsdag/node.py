...
class Node:
    ...
    def __init__(self, parent: Optional['Node'] = None, arc_label: Optional[Any] = None,
        ...
        self.path_label: List = []  # labels of the path to here
        ...
        if parent is None:
            ...
            if isinstance(arc_label, list):
                parent.children[get_hashcode(arc_label)] = self
            else:
                parent.children[arc_label] = self

    @staticmethod
    def create_root(label: List, parameters: AbstractHSParameters) -> 'Node':
    ...
    def add_child(self, arc_label: Any, child: 'Node') -> None:
        if isinstance(arc_label, list):
            self.children[get_hashcode(arc_label)] = child
        else:
